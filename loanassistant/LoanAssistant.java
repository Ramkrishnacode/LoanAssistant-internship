...
public class LoanAssistant extends JFrame {
  ...
  GridBagConstraints gridConstraints;
	   ...
	   //balance textfield focus transfer listener
	   ...
	   //interest textfield focus transfer listener
	  ...
	  //setting the frame
	   setTitle("Loan Assistant");
	   pack();/*<---The pack() method is defined in Window class in Java and it sizes 
	   ...
	   //this.myControl.setFocusable(false);
	...
	private void computeButtonActionPerformed(ActionEvent e)
	{
		...
		//reset the payment prior to fix at two decimal points
		payment =
				Double.valueOf(paymentTextField.getText()).doubleValue();
		
		//showAnalysis
		
		analysisTextArea.setText("LoanAssistant balance:$" +new DecimalFormat("0.00").format(balance));
